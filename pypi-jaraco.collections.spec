...
Version  : 3.7.0
Release  : 35
URL      : https://files.pythonhosted.org/packages/2a/5d/0b788955f29b783bab7bfca513380bea5a198a8b1eb92874c5d59f6b5a80/jaraco.collections-3.7.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/2a/5d/0b788955f29b783bab7bfca513380bea5a198a8b1eb92874c5d59f6b5a80/jaraco.collections-3.7.0.tar.gz
...
%prep
%setup -q -n jaraco.collections-3.7.0
cd %{_builddir}/jaraco.collections-3.7.0
pushd ..
cp -a jaraco.collections-3.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667227329
